...
#### run code.
pred_data_dir = '/data/xujs/Project/HiC2PoreC/code/H2P/Analysis_Results/2024-07-24_predict_mESC_New_MCI_5kb/chrom_region_Unobserved_MCI'
...
for i in range(len(fish_20_regions)):
    ...
    data = np.load(f'{pred_data_dir}/HiPore-C_mESC_5kb_{chrom_region}_Unobserved_3way_MCI.npy')
    data = data + node_id_start - 1
    pred_score = np.load(f'{pred_data_dir}/HiPore-C_mESC_5kb_{chrom_region}_Unobserved_3way_MCI_pred_score.npy').reshape(-1)
